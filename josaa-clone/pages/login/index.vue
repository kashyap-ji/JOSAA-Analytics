	...
	<div class="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div class="max-w-md mx-auto">
				<div>
					<h1 class="text-2xl font-semibold w-80">Welcome Back</h1>
				</div>
				<div class="divide-y divide-gray-200">
					<div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						...
						<br>
						<div class="relative">
							<button class="bg-blue-500 hover:bg-blue-400 text-white rounded-md px-2 py-1">Submit</button>
						</div>
						<NuxtLink to="/signup" class="text-gray-400 text-sm hover:text-red-500" >
